...
class LlamaStackToolInput(BaseModel):
    """Input schema for LlamaStack tool.
...
class LlamaStackTool(BaseTool):  # type: ignore[override]
    """LlamaStack tool.
    ...
    args_schema: Type[BaseModel] = LlamaStackToolInput
