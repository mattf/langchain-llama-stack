...
class LlamaStackLoader(BaseLoader):
    ...
    """
    LlamaStack document loader integration
    ...
    Instantiate:
        .. code-block:: python
            ...
            from langchain_community.document_loaders import LlamaStackLoader

            loader = LlamaStackLoader(
                # required params = ...
                # other params = ...
            )
