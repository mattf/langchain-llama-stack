...
class LlamaStackRetriever(BaseRetriever):
    ...
    """LlamaStack retriever.

    # TODO: Replace with relevant packages, env vars, etc.
    Setup:
        Install ``langchain-llama-stack`` and set environment variable
        ``LLAMASTACK_API_KEY``.
    ...
    Instantiate:
        .. code-block:: python
            ...
            from langchain-llama-stack import LlamaStackRetriever
